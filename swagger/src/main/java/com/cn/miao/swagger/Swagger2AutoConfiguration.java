package com.cn.miao.swagger;

import com.cn.miao.swagger.properties.Swagger2Properties;
...
/**
 * @title: Swagger2AutoConfiguration
 * @description:
 * @author: dengmiao
...
@EnableSwagger2
@Profile("!prod")
@ConditionalOnProperty(name="totoro.swagger2.enable",havingValue = "true",matchIfMissing = false)
